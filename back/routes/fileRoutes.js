...
// Серверный код для поиска файла по имени в базе данных
...
router.post('/uploadByName', async (req, res) => {
    try {
        ...
        for (const filename of filenames) {
            console.log(`Получен запрос для файла с именем: ${filename}`);
            ...
            console.log(`Файл ${filename} успешно загружен или обновлен в БД!`);
        }
